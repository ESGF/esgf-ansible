...
1. Clone the esgf-ansible repo at the current version, for example version 4.0.2 ::

    git clone --branch 4.0.2 https://github.com/ESGF/esgf-ansible.git && cd esgf-ansible
