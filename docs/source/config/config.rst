...
See the sample inventory file, `sample.hosts <https://github.com/ESGF/esgf-ansible/blob/4.0.1/sample.hosts>`_ for more information regarding inventory files.
...
See the host variables directory, `host_vars <https://github.com/ESGF/esgf-ansible/blob/4.0.1/host_vars>`_, and find the sample file
that best describes the desired use case.
Also see the sample host variable file, `host_vars/myhost.my.org.yml <https://github.com/ESGF/esgf-ansible/blob/4.0.1/host_vars/myhost.my.org.yml>`_ for a comprehensive overview.
