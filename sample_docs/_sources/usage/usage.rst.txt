...
See the sample inventory file, `sample.hosts <https://github.com/ESGF/esgf-ansible/blob/master/sample.hosts>`_ for more information. 
...
See the sample host variable file, `host_vars/myhost.my.org.yml <https://github.com/ESGF/esgf-ansible/blob/master/host_vars/myhost.my.org.yml>`_ for more information.
...
These examples are **not** comprehensive, they only show some common patterns and useful commands. Refer to the docs linked above and the ``--help`` flag for more information.
...
Deployments are done in the order of includes in `install.yml <https://github.com/ESGF/esgf-ansible/blob/master/install.yml>`_.
...
Controlling the deployment is done with tags. The tags available in the `install.yml <https://github.com/ESGF/esgf-ansible/blob/master/install.yml>`_ play are ``base``, ``idp``, ``index``, and ``data``.
